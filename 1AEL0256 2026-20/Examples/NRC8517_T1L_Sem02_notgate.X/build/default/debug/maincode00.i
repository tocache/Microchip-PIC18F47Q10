...
configuro:
    ...
    bsf TRISA, 0, 1 ;((PORTA) and 0FFh), 0, a como entrada
    bcf ANSELA, 0, 1 ;((PORTA) and 0FFh), 0, a como digital
    bcf TRISC, 0, 1 ;((PORTC) and 0FFh), 0, a como salida
    bcf ANSELC, 0, 1 ;((PORTC) and 0FFh), 0, a como digital
...
inicio: ;codigo de la aplicacion
    ...
    bcf LATC, 0, 1 ;rpta verdad, pongo ((PORTC) and 0FFh), 0, a a cero
    bra inicio ;salto a label inicio
falso:
    bsf LATC, 0, 1 ;pongo ((PORTC) and 0FFh), 0, a a uno
    bra inicio ;salto a label inicio
