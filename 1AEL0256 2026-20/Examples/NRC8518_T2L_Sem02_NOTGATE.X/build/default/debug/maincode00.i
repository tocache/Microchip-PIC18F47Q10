...
configuro:
    ...
    bsf TRISB, 0, 1 ;puerto ((PORTB) and 0FFh), 0, a como entrada
    bcf ANSELB, 0, 1 ;puerto ((PORTB) and 0FFh), 0, a como digital
...
inicio: ;aplicacion de la NOT GAY
    btfss PORTB, 0, 1 ;pregunto si el puerto ((PORTB) and 0FFh), 0, a es uno
    bra es_falso ;rpta falsa, salto a label es_falso
    bcf LATC, 0, 1 ;rpta verdad, pongo puerto ((PORTC) and 0FFh), 0, a en cero
    bra inicio ;salto a label inicio
es_falso:
    bsf LATC, 0, 1 ;pongo puerto ((PORTC) and 0FFh), 0, a en uno
    bra inicio ;salto a label inicio
